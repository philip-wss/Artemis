...
public class Course extends DomainObject {
    ...
    public void setAthenaFormativeEnabled(boolean athenaFormativeEnabled) {
    ...
    public void setAthenaGradingEnabled(boolean athenaGradingEnabled) {
        this.athenaGradingEnabled = athenaGradingEnabled;
    }
